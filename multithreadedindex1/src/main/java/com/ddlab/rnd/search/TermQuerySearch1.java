...
public class TermQuerySearch1 {
    ...
    private static File indexDirPath = new File(rootDir+"/"+"local/data");

    public static void main(String[] args) throws Exception {
    	
//    	String queryStr = "COURSE00003";//For anything search
//    	String queryStr = "ZIP00001"; // For zip code
    	String queryStr = "ZIP00006";//"COURSE04998";
